...
public class Base64 {
    ...
    public static byte[] decodeBase64(String encodedData){return decodeBase64(encodedData.getBytes(StandardCharsets.UTF_8));}
    ...
    public static String encodeBase64String(byte[] pArray){return new String(encode(pArray), StandardCharsets.UTF_8);}
